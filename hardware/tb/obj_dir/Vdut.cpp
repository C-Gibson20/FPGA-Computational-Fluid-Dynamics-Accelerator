...
Vdut::Vdut(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , rst{vlSymsp->TOP.rst}
    , en{vlSymsp->TOP.en}
    , collider_ready{vlSymsp->TOP.collider_ready}
    , in_collision_state{vlSymsp->TOP.in_collision_state}
    , omega{vlSymsp->TOP.omega}
    , init_c0{vlSymsp->TOP.init_c0}
    , init_cn{vlSymsp->TOP.init_cn}
    , init_cne{vlSymsp->TOP.init_cne}
    , init_ce{vlSymsp->TOP.init_ce}
    , init_cse{vlSymsp->TOP.init_cse}
    , init_cs{vlSymsp->TOP.init_cs}
    , init_csw{vlSymsp->TOP.init_csw}
    , init_cw{vlSymsp->TOP.init_cw}
    , init_cnw{vlSymsp->TOP.init_cnw}
    , testing_cs_n_data_in{vlSymsp->TOP.testing_cs_n_data_in}
    , testing_c0_data_in{vlSymsp->TOP.testing_c0_data_in}
    , u_x{vlSymsp->TOP.u_x}
    , u_y{vlSymsp->TOP.u_y}
    , rho{vlSymsp->TOP.rho}
    , u_squared{vlSymsp->TOP.u_squared}
    , step{vlSymsp->TOP.step}
    , barriers{vlSymsp->TOP.barriers}
    , rootp{&(vlSymsp->TOP)}
{
